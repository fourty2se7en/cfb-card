...
# must NOT be written as is_fcs(home) != is_fcs(away): that also catches FCS
# against the OTHER bucket, which is Division II and III. Those games are FCS
# teams beating weaker opposition, they push the median the wrong way, and they
# dragged the measured gap down to 7 points when the market prices these games
# at about 25. The result was every FCS team floating 18 points too high.
cross = played[[ (is_fbs(h) and is_fcs(a)) or (is_fcs(h) and is_fbs(a))
