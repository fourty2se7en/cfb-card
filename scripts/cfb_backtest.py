...
print("=" * 78)
print("A strategy may become a graded pick only if its 95% interval sits ENTIRELY")
print("above 52.4%. 'No evidence either way' is not permission. If nothing clears,")
print("the card keeps showing numbers and makes no picks, which is the honest")
print("outcome and not a failure of the build.")
